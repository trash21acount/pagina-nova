...
export function BanterLoader() {
  return (
    <div className="relative flex h-[1.1em] w-[1.1em] items-center justify-center">
      ...
      <style jsx>{`
        ...
        .banterLoaderBox:nth-child(3n) {
          margin-right: 0;
          margin-bottom: 6px;
        }
        .banterLoaderBox:nth-child(1)::before,
        .banterLoaderBox:nth-child(4)::before {
          margin-left: 26px;
        }
        .banterLoaderBox:nth-child(3)::before {
          margin-top: 52px;
        }
        .banterLoaderBox:last-child {
          margin-bottom: 0;
        }

        .banterLoaderBox:nth-child(1) {
          animation: moveBox-1 7s infinite;
        }
        .banterLoaderBox:nth-child(2) {
          animation: moveBox-2 7s infinite;
        }
        .banterLoaderBox:nth-child(3) {
          animation: moveBox-3 7s infinite;
        }
        .banterLoaderBox:nth-child(4) {
          animation: moveBox-4 7s infinite;
        }
        .banterLoaderBox:nth-child(5) {
          animation: moveBox-5 7s infinite;
        }
        .banterLoaderBox:nth-child(6) {
          animation: moveBox-6 7s infinite;
        }
        .banterLoaderBox:nth-child(7) {
          animation: moveBox-7 7s infinite;
        }
        .banterLoaderBox:nth-child(8) {
          animation: moveBox-8 7s infinite;
        }
        .banterLoaderBox:nth-child(9) {
